...
//       var solution = new StockPriceFluctuation().new Solution();
   }
    ...
    class StockPrice {
       int max;
        ...
        public void update(int timestamp, int price) {
            ...
            int prePrice = order.getOrDefault(timestamp,0);
            order.put(timestamp,price);
            if(prePrice>0){
